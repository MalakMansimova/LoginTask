    ...
    public class BasketController : Controller
    {
        ...
        public IActionResult AddBasket(int id)
        {
            ...
            else
            {
                ...
                //List<BasketVM> basketVMList = new List<BasketVM>();
                ...
                Response.Cookies.Append(COOKIES_BASKET, JsonConvert.SerializeObject(basketVMList));
            return RedirectToAction("Index","Services");

            /*return Json(id);*/     //Cookie muveqqeti yaddash
        }
    }
}
